...
<div id="content-slide">
    ...
    <div class="container" id="before-slide">
        ...
        <div class="product-one">
            <div class="top">
                <a href="#" title="" class="main-title" style ="font-weight: bold;">SẢN PHẨM BÁN CHẠY</a>
            </div>
            <div class="bot">
                @if ($event1)
                <div class="left">
        ...
        <div class="product-three">
            <div class="top">
                <a href="#" title="" class="main-title" style ="font-weight: bold;">SẢN PHẨM MỚI</a>
            </div>
            <div class="bot">
                <div class="left">
                    <div class="image">
        ...
        <div class="product-two">
            <div class="top">
                <a href="#" class="main-title" style ="font-weight: bold;">SẢN PHẨM NỔI BẬT</a>
            </div>
            <div class="bot">
