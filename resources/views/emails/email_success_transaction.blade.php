<div style="width: 100%;max-width: 600px;margin:0 auto">
    ...
    <div style="background: #f4f5f5;box-sizing: border-box;padding: 15px">
        <p style="margin:2px 0;color: #333">Email : nguyenthanhtrung@gmail.com</p>
        <p style="margin:2px 0;color: #333">Phone : 0989275330</p>
        <p style="margin:2px 0;color: #333">Face : <a href="https://www.facebook.com/">Nguyễn Thành Trung</a></p>
    </div>
</div>