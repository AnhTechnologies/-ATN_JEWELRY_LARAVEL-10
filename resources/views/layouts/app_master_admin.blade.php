...
<head>
    ...
    <title>{{ ucwords($title_page ?? "Đồ án tốt nghiệp")  }} | Jewelry - Admin</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('admin.statistical') }}" class="brand-link navbar-info">
                <img src="{{ url('images/logo4.png') }}" alt="AdminLTE Logo"
                    class="brand-image" style="opacity: .8">
                <span class="brand-text font-weight-bold">Trang Quản Trị</span>
            </a>/
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="image">
                        <img src="{{ pare_url_file(get_data_user('admins', 'avatar')) }}" class="brand-image img-circle elevation-2"
        ...
        <footer class="main-footer">
            <strong>Đồ Án Tốt Nghiệp&nbsp;{{ date("d/m/Y") }}&nbsp;<a href="https://www.linkedin.com/in/anhnhwork" target="_blank">Nguyễn Hoàng Anh</a>.</strong>
            All rights reserved.
