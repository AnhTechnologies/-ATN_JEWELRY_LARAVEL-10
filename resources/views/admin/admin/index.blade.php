                            ...
                            @if (isset($admins))
                                    @foreach($admins as $key => $admin)
                                        <tr>
                                            ...
                                            <td class ="text-center align-middle">{{ $admin->phone }}</td>
                                            ...
                                            <td class ="text-center align-middle">{{  $admin->created_at }}</td>
                                            <td class ="text-center align-middle">
                                                <a href="{{ route('admin.account_admin.update', $admin->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i>&nbsp;Sửa</a>
                                                <a href="{{  route('admin.account_admin.delete', $admin->id) }}" class="btn btn-sm btn-danger js-delete-confirm"><i class="fa fa-trash"></i>&nbsp;Xoá</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
