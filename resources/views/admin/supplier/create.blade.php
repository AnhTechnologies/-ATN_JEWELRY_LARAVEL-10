                    ...
                    <form role="form" action="" method="POST">
                         ...
                         <div class="row">
                            ...
                            <div class="form-group {{ $errors->first('sl_name') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ old('sl_name') }}" name="sl_name"  placeholder="Nhập tên nhà cung cấp ...">
                            ...
                            <div class="form-group {{ $errors->first('sl_address') ? 'has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" value="{{ old('sl_address') }}"  name="sl_address"  placeholder="Nhập địa chỉ ...">
