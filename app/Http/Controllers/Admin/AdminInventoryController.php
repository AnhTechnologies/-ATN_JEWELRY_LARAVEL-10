...
class AdminInventoryController extends Controller
{
	...
	public function add()
    {
        ...
        $viewData = [
			// 'warehouses' => $warehouses,
            'title_page' => 'tạo Nhập kho',
		];
        return view('admin.inventory.import_add', compact('products'), $viewData);
    }
    ...
    public function edit($id)
    {
        ...
        $viewData = [
			// 'warehouses' => $warehouses,
            'title_page' => 'Chỉnh sửa Nhập kho',
		];
        return view('admin.inventory.import_update', compact('products','warehouse'), $viewData);
    }
